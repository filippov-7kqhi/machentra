# Payments and the Worker: MachEntra

## How machentra.shop takes payment
...
`GET /stats` returns them, stored in the KV namespace `machentra-EVENTS`.

- Worker: `https://machentra-collector.stellapark1141.workers.dev`
...
needed: without it the script refuses a key whose account name is not MachEntra.
...
& {
  ...
  Set-Location "C:\Users\Hp\uk-stores\machentra\stripe"
...
- delete the KV namespace `machentra-EVENTS`. It holds the dashboard's data.
